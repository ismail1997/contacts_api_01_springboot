package io.ismail.contactapi.web;

import io.ismail.contactapi.domain.Contact;
import io.ismail.contactapi.service.ContactService;
...
public class ContactResource {
    ...
    public byte[] getPhoto(@PathVariable("filename") String filename) throws IOException {
        return Files.readAllBytes(Paths.get(Constant.PHOTO_DIRECTORY_LOCATION+filename));
    }
